package com.cosentino.gateway.security.oauth2;

import com.cosentino.gateway.config.oauth2.OAuth2Properties;
import com.cosentino.gateway.web.filter.RefreshTokenFilter;
import com.cosentino.gateway.web.rest.errors.InvalidPasswordException;
